...
const productos = [
  ...
  { id: 2, nombre: 'Camisa blanca algodón', precio: '29,95 €', imagen: 'https://images.unsplash.com/photo-1622445272461-c6580cab8755?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
  { id: 3, nombre: 'Pantalón sastre negro', precio: '39,95 €', imagen: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c' },
...
const Home = () => {
  return (
    <div className="w-screen min-h-screen bg-white text-black relative">
      ...
      >
        <span className="font-semibold text-black">Memories Division</span>
      ...
      {/* HERO */}
      <section className="h-[70vh] flex flex-col justify-center items-center text-center px-6 mt-16">
